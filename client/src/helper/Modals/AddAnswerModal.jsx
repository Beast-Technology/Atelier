...
export default function AddAnswerModal({ productName, questionID, questionBody }) {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    axios.post(`${process.env.API_URL}/qa/questions/${questionID}/answers`, {
      question_id: questionID, body, name, email, photos,
    })
    ...
    <div className="modal-box modal-adda">
      ...
      <main>
        <form className="modal-form" onSubmit={handleSubmit}>
          <label>Your Answer *
            <textarea className="modal-input" onChange={handleQuestionChange} name="answer_body" maxLength="1000" placeholder="Write your answer here..." required />
          </label>
